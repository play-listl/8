document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'Avatar': [20, 12, 8, 6, 4, 3, 2, 0],
        'Avengers: Endgame': [16, 16, 11, 7, 5, 4, 2, 1],
        'Titanic': [12, 12, 14, 9, 7, 5, 3, 2],
        'Star Wars: The Force Awakens': [10, 10, 11, 12, 8, 6, 4, 4],
        'Avengers: Infinity War': [8, 8, 8, 9, 11, 8, 5, 5],
        'Spider-Man: No Way Home': [6, 6, 7, 7, 8, 10, 7, 5],
        'Jurassic World': [5, 5, 5, 6, 7, 9, 9, 7],
        'The Lion King': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'Avatar', year: '$2.923 billion' },
        { city: 'Avengers: Endgame', year: '$2.798 billion' },
        { city: 'Titanic', year: '$2.247 billion' },
        { city: 'Star Wars: The Force Awakens', year: '$2.068 billion' },
        { city: 'Avengers: Infinity War', year: '$2.048 billion' },
        { city: 'Spider-Man: No Way Home', year: '$1.922 billion' },
        { city: 'Jurassic World', year: '$1.671 billion' },
        { city: 'The Lion King', year: '$1.662 billion' }
    ];
